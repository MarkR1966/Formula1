...
def home():
    ...
    #f1dat = F1dat.query.order_by(F1DriversandTeams.id) Your organisation doesn't allow you to use work content with this app                                            #get records from database to display on web page
