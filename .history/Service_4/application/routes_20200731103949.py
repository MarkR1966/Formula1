...
def generate_driver():
    r_driver = requests.get('http://localhost:5001/driver').text      #get result from Service_2
    r_team = requests.get('http://localhost:5002/team').text          #get result from Service_3
